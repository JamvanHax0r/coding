...
$text = $_POST['code'];
?>
<title>Script En&DeC0de by JamvanHax0r</title>
<STYLE>
...
<center>
<div class="jaya">BlackHat Cyber Crew</div>
<form method="post"><br>
...
echo "<from><center><h3>HASIL / RESULT</h3></center><textarea cols=80 rows=10 class='inputz' readonly>".$html."</textarea><BR/><BR/><h2>Special Thank's to : X'1n73ct</h2></center></from>";
?>
